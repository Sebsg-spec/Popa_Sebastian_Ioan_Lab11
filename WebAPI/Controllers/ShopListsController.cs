...
namespace WebAPI.Controllers
{
    public class ShopListsController : Controller
    {
        ...
        {
              return _context.ShopList != null ? 
                          View(await _context.ShopList.ToListAsync()) :
                          Problem("Entity set 'WebAPIContext.ShopList'  is null.");
        }

        // GET: ShopLists/Details/5
        public async Task<IActionResult> Details(int? id)
        {
            if (id == null || _context.ShopList == null)
            {
                return NotFound();
            }
